...
> [!CAUTION]
> TODO предложить вариант подготовки встречного сражения, например, при прибытии флота в систему)
...
Боевые задачи (Agendas), Благословления (Crusade Blessings)

### Результаты сражения
Опыт, Награды, Выведенные из строя + Шрамы Отряда, другие результаты сражения
...
- Почитаемые Герои (1-3 RP) = добавить любе доступное вашей фракции (из любого детача) улучшение (Enhancement'ы) одному из ваших Персонажей (Character). Очки его стоимости пересчитаются соответственно.  
...
> [!CAUTION]
> TODO При добавлении отрядов в Боевые Порядки (не)разрешается использовать юниты из легенд?
...
- отряд получит 1 XP за каждый 3й уничтоженный отряд в конце сражения
> [!CAUTION]
> TODO Уточнить, в конце каждого сражения отряд получает опыт и за все отряды, уничтоженные в предыдущих сражениях?
...
Особенности отряда, согласно его тэгов, описаны в разделе [Боевых Особенностей](https://wahapedia.ru/wh40k10ed/the-rules/pariah-nexus/#Battle-Traits) правил Крестового Похода Нексуса Парии. Также, в правилах Крестового Похода вашей фракции наверняка есть раздел, посвящённый данной теме.  
...
Правила по Реликвиям описаны в [соответствующем разделе](https://wahapedia.ru/wh40k10ed/the-rules/crusade-rules/#Crusade-Relics) общих правил по Крестовым Походам и в разделе [Реликвий](https://wahapedia.ru/wh40k10ed/the-rules/pariah-nexus/#Crusade-Relics) правил Крестового Похода Нексуса Парии. Также, в правилах Крестового Похода вашей фракции наверняка есть раздел, посвящённый данной теме.  
> [!NOTE]
> Обратите внимание, что мы используем только общие правила для всех фракций. Подраздел Faction Crusade Blessings правил Крестового Похода Нексуса Парии не будет использован в данной кампании!
...
Также по ходу кампании, чаще всего при наступлении очередной фазы, все участники будут собираться и решать, какие глобальные действия будут предпринимать их флоты и альянсы.
