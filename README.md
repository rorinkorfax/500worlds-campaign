...
> [!CAUTION]
> Обсудить условия передвижения в рамках Боевых Операций, вместо действий передвижения.
...
Приводит к перемещению флота к целевому миру.  
...
При успехе, предотвращает перемещение целевого флота - такие операции как "Пустотный переход" и Боевые Операции типа "Захват опорной точки",  "Орбитальное вторжение", "Планетарная бомбардировка", если флот собирается атаковать не текущую планету своёго пребывания.
...
> [!WARNING]
> Флоты передвигаются только посредствам проведения Боевых Операций или Операций "Пустотный переход"
