...
Ссылки:  
[Правила по Крестовым Походам - Crusade Rules](https://wahapedia.ru/wh40k10ed/the-rules/crusade-rules/)  
[Правила по Нексусу Парии - Pariah Nexus Crusade](https://wahapedia.ru/wh40k10ed/the-rules/pariah-nexus/)  
...
- Пометки (особые достижения, награды, штрафы и т.д. - весь исторический багаж, нажитый коллективными усилиями всех участников данных Боевых Порядков)  
...
1 RP = +200 очков к Силам Крестового Похода (не Армии!)  
1-3 RP = добавить любе доступное вашей фракции (из любого детача) улучшение (Enhancement'ы) одному из ваших Персонажей (Character). Очки его стоимости пересчитаются соответственно.  
3 RP = присвоить отряду с 30 XP Легендарный статус и позволить ему развиваться ещё дальше.  
1 RP = перевооружить отряд, изменить состав его вооружения.  
1-5 RP = удалить один Боевой Шрам (Battle Scar) с одного отряда.  
1-4 RP = увеличить отряд, согласно правилам его карточки (например, у вас в Силах был отряд пехоты из 10 моделей, но у него есть возможность иметь 15 или 20 моделей. Этим действием вы можете увеличить данный отряд для следующиего набора в Армию до, напрмиер, 20 моделей)  
Х RP = в правилах Крестового Похода для вашей фракции есть раздел с Реквизицией, специфичной для вашей фракции. Там уж смотрите сами.
...
- Награды и Шрамы Отряда (Battle Honours, Battle Scars; см. [ниже](#боевые-особенности-battle-traits))
...
- отряд получит 1 XP за участие в сражении в конце этого сражения
- отряд получит 1 XP за каждый 3й уничтоженный отряд в конце сражения (TODO в конце каждого сражения отряд получает опыт и за все отряды, уничтоженные в предыдущих сражениях?)
- в конце каждого сражения один из отрядов каждой Армии может быть Отмечен Величием (Marked for Greatness) и получит доп. 3 XP
...
Стоит также отметить, что отряды с тэгами EPIC HEROES, FORTIFICATIONS, SWARMS, а также Призванные отряды и Отряды Замены.
...
Магистр Войны будет подсказывать и напоминать, когда стоит уделить этому время, но все мы люди-человеки, а значит лучше следите сами за своим огородом. А лучше, ещё и соседу помогайте. Так мир станет лучше, чище и добрей. Так Победим!
Все изменения в этих карточках следуюет сообщать Представителю Администратума, чтобы они были учтены и занесены в лог кампании.
