...
![Карта](pictures/map-phase2-1.jpg)

<ins>Фазы Кампании</ins>
- [Начало](/phases/phase0.md)
- [Фаза 1](/phases/phase1.md)
- [Фаза 2](/phases/phase2.md)
- ~Фаза 3~
- ~Фаза 4~
- ~Фаза 5~
- ~Фаза 6~

Кампания закончена досрочно. Финальный счёт:  
**Империум 57**  
**Хаос 49**  
**Ксеносы 53**  
<ins>Победа Империума в кампании.</ins>
...
9. Задеплойте армии (начиная с Защищающегося, TITANIC считается за 2 деплоя на этом шаге)
10. Редеплой (сначала полностью переставляется Атакующий, после Защитник)
11. Определите, кто первый ходит (см.миссии. Чаще всего - первый ход за Атакующим, кроме миссии Зачистка и, возможно, Абордаж)
...
#### 3. Соберите Армию
В первой фазе размер Армии в сражениях = 1000 очков. Для дальнейших фаз, размер Армии растёт в порядке 1250 очков для фазы2, 1500 очков для фазы3, 2000 очков для дальнейших фаз.
...
В этот момент проведения Операции/сражения, по результатам сражения изменяются показатели отрядов. 
Все уничтоженные отряды проходят проверки Выведенных из Строя - для каждого отряда, который был уничтожен в сражении, владелец кидает D6: и при суммарном результате 1, отряд получает на выбор владельца либо Разрушительный Удар (и теряет одну из имеющихся у него наград), либо случайный [Боевой Шрам](https://wahapedia.ru/wh40k10ed/the-rules/crusade-rules/#Battle-Scars).  
Далее, по умолчанию, каждый отряд получает 1 XP за участие в сражении и один из отрядов на выбор его владельца становится Отмечен Величием (получает доп. 3 XP). После чего, применяются все дополнительные бонусы опыта по иным правилам, как например доп.опыт за выполнение Боевой Задачи (Agenda).  
...
> [!TIP]
> Обратите внимание, что улучшению подвергается всего ОДИН профиль оружия (даже если на модели или в отряде несколько одноимённых оружий) для ОДНОЙ модели в отряде! Но если у выбранной модели несколько единиц оружия, выбранного профиля, изменения применяются ко всем этим единицам оружия выбранного профиля для выбранной модели.
