...
> [!NOTE]
> По факту, вариантов подхода к правилам строительства и последовательностей действий три:  
> 1. (согласно правил) Выбор операций (Стройка) -> Реализации операций строительства -> Реализации Боевых операций -> Общее строительство (1 постройка на Альянс)
> 2. Выбор операций (Стройка) -> Реализации операций строительства -> Реализации Боевых операций
> 3. Выбор операций (Стройка) -> Реализации Боевых операций  -> Реализации операций строительства
...
На этом шаге завершается строительство на всех планетах, на которых были начаты стройки в рамках соответствующих операций.  
